...
## 10. Decisions this architecture must honour

Recorded as ADRs in `docs/adr/` (0001–0019, 0022–0028 accepted): the lossless ordered attribute store as the
...
edition applied and its basis (ADR-0028). The original
